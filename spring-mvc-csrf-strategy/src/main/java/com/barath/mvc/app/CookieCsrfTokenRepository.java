...
public class CookieCsrfTokenRepository implements CsrfTokenRepository {
    ...
    public CsrfToken generateToken(HttpServletRequest request) {
        ...
        if(logger.isInfoEnabled()) { logger.info("csrf: generating new token "); }
    ...
    public void saveToken(CsrfToken token, HttpServletRequest request, HttpServletResponse response) {
        ...
        if(logger.isInfoEnabled()) { logger.info("csrf: saving token  {}", tokenValue); }
    ...
    public CsrfToken loadToken(HttpServletRequest request) {
        ...
        if (cookie == null) {
            ...
            if(logger.isInfoEnabled()) { logger.info("csrf: loading token from cookie {}", token); }
